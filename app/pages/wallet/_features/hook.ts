import { CreateTransactionPayload, CreateTransactionResponse, CreateWalletPayload, FlutterWavePaymentSubmit, PaginationMeta, TransactionVerificationResponse, WalletInfo, WalletTransactionList } from "@/app/lib/type";
