// app/pages/wallet/payment-made/PaymentMadeClient.tsx
        ...
        <DashboardLayout>
            <div className="text-black">
                <div className="bg-white p-8 rounded-lg max-w-3xl mx-auto drop-shadow-2xl mt-10">
                    ...
                    <PaymentItem label="Date" value={formattedDate(data.data?.createdAt)} />
                    <PaymentItem label="Reference" value={data.data?.tx_ref} />
                    <PaymentItem label="Amount" value={`${data?.data.amount}`} />
                </div>
            </div>
        </DashboardLayout>
    );
...
export default PaymentMadeClient;
