...
import { FieldType, SurveyForm } from "@/app/lib/type";
import React from "react";
interface SurveySelectOptionManagerProps {
	index: number;
	newOptions: string[];
	setNewOptions: React.Dispatch<React.SetStateAction<string[]>>;
	formFields: Field[];
	setFormFields: React.Dispatch<React.SetStateAction<SurveyForm>>;
}
...
const SurveySelectOptionManager: React.FC<SurveySelectOptionManagerProps> = ({
	index,
	newOptions,
	setNewOptions,
	formFields,
...
export default SurveySelectOptionManager;
