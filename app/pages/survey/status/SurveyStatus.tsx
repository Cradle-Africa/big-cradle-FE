...
import { useActivateSurvey, useSuspendSurvey } from '../_features/hooks';
...
const SurveyStatus: React.FC<Props> = ({ setOpen, uniqueId, survey, activate, suspend }) => {
            ...
            >
                ...
                {activate && (
                    <div className="items-center text-center mt-5">
                        <h2 className="text-md font-semibold text-gray-700 mb-4">Activate {survey.surveyName}</h2>
                ...
                {suspend && (
                    <div className="items-center text-center mt-5">
                        <h2 className="text-md font-semibold text-gray-700 mb-4">Suspend {survey.surveyName}</h2>
