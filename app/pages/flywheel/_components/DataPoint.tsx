...
const DataPoint = () => {
	return (
		<div className="grid grid-cols-2 lg:grid lg:grid-cols-2 gap-5 mt-5">
			<div className="border border-gray-200 rounded-lg px-6 py-6">
				...
				<p className="text-[#494949] text-[14px] mt-5">
					Product pages with 5+ reviews see 34% more add-to-cart actions and 22% higher purchase completion rates.
				</p>
