...
import { UserRoundMinus, UserRoundX, FileText } from 'lucide-react';
import SuspendUserComponent from '@/app/components/user/SuspendUserComponent';
import DeleteUserComponent from '@/app/components/user/DeleteUserComponent';

export default function UserDetailDropDownMenu() {
    ...
    return (
        <div className="relative inline-block text-left" ref={menuRef}>
            ...
            {/* Dropdown Menu */}
            {open && (
                <div className="absolute right-0 mt-2 w-50 bg-white rounded-md shadow-md border border-gray-100 z-50">
                    <ul className="py-1">
                        <li className='px-1'>
                            <button
