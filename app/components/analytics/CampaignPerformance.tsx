...
const CampaignPerformance = () => {
    ...
    return (
        <div className="relative w-93 md:w-full mt-5 rounded-md border border-gray-100 px-5 py-5 bg-white">
            <div className='flex justify-between items-center mb-4'>
                <h2 className="text-sm md:text-md text-gray-700 font-semibold mb-4">Campaign Performance</h2>
