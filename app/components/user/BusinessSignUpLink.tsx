...
export default function BusinessSignUpLink({ signUpToken, businessEmail, adminBusinessUserId }: BusinessSignUpProps) {
    ...
    const [form, setForm] = useState<BusinessLinkForm>({
    ...
    const next = () => {
        const validationErrors = validateBusinessLinkStep(step, form);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const validationErrors = validateBusinessLinkSignUp(form);
        setErrors(validationErrors);
        ...
        try {
            ...
            await BusinessSignUpLinkService(form, signUpToken);
            toast.dismiss();
