...
export const fetchTopBusinesses = async () => {
	try {
		const response = await axios.get(`/super-admin-dashboard/top-business-users`);
		return response.data.data;
	} catch (error: any) {
		console.error("Error fetching data:", error);
		throw new Error("Failed to fetch data");
...
export const fetchTopLocations = async () => {
	try {
		const response = await axios.get(`/super-admin-dashboard/top-locations`);
		return response.data.data;
	} catch (error: any) {
		console.error("Error fetching data:", error);
		throw new Error("Failed to fetch data");
